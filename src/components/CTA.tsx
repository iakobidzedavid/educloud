export default function CTA() {
  return (
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-yellow-500 to-amber-500">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-white text-yellow-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition font-semibold">
            Start Free Trial
          </button>
        ...
        <p className="text-amber-50 text-sm mt-8">
