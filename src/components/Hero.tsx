...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-red-50 to-white pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/services" className="inline-block border-2 border-red-500 text-red-600 hover:bg-red-50 font-bold py-3 px-8 rounded-lg transition-colors">
            Learn More
          </Link>
        </div>
      </div>
